...
public class Registration extends JFrame {
	...
	private void closeForm() {
	    int choice = JOptionPane.showConfirmDialog(null, "Are you sure you want to close the form?", "Close Form", JOptionPane.YES_NO_OPTION);
	    if (choice == JOptionPane.YES_OPTION) {
	        System.exit(0); // Close the form
	    }
	}
		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String sql = "INSERT INTO form(name,Username,Password,ConPassword,Email,Phone,Address)VALUES(?,?,?,?,?,?,?)";
